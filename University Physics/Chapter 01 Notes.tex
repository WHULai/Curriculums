...
\subsubsection{位置矢量}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.08]{"D:/Curriculums/University Physics/Chapter 01 images/pic1.png"}
        % \caption{}
        \label{pic1}
    \end{wrapfigure}
...
\subsubsection{运动方程（直角坐标系下）}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.08]{"D:/Curriculums/University Physics/Chapter 01 images/pic2.png"}
        % \caption{}
        \label{pic2}
    \end{wrapfigure}
...
\subsubsection{位移\(\Delta \overrightarrow{r}\)（位置矢量的改变量）}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.08]{"D:/Curriculums/University Physics/Chapter 01 images/pic3.png"}
        % \caption{}
        \label{pic3}
    \end{wrapfigure}
...
\subsubsection{路程\(\Delta s\)实际轨迹}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.05]{"D:/Curriculums/University Physics/Chapter 01 images/pic4.png"}
        % \caption{}
        \label{pic4}
    \end{wrapfigure}
...
\subsubsection{平均速度}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.08]{"D:/Curriculums/University Physics/Chapter 01 images/pic5.png"}
        % \caption{}
        \label{pic5}
    \end{wrapfigure}
...
\subsubsection{平均加速度}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.08]{"D:/Curriculums/University Physics/Chapter 01 images/pic6.png"}
        % \caption{}
        \label{pic6}
    \end{wrapfigure}
...
\subsubsection{瞬时加速度}
    ...
    \begin{wrapfigure}{r}{4cm}
        \centering
        \includegraphics[scale=0.05]{"D:/Curriculums/University Physics/Chapter 01 images/pic7.png"}
        % \caption{}
        \label{pic7}
    \end{wrapfigure}
