...
\newcommand{\hmwkTitle}{Vector Algebra and Analytic Geometry in Space}
...
\begin{homeworkProblem}
    已知\((\vec{a} \times \vec{b}) \cdot \vec{c} = 2\)，求\(\left[(\vec{a} \times \vec{b}) \times
    (\vec{b} + \vec{c})\right] \cdot (\vec{c} + \vec{a})\)。
    ...
    \[
        \begin{split}
            & \left[(\vec{a} \times \vec{b}) \times (\vec{b} + \vec{c})\right] \cdot (\vec{c} + \vec{a})
            \\
            &= \left[\vec{a} \times \vec{b} + \vec{a} \times \vec{c} + \vec{b} \times \vec{b} +
            \vec{b} \times \vec{c}\right] \cdot (\vec{c} + \vec{a})
        \end{split}
    \]

    由\(\vec{b} \times \vec{b} = 0\)，故
    \\
    ...
    \[
        \begin{split}
            & \left[(\vec{a} \times \vec{b}) \times (\vec{b} + \vec{c})\right] \cdot (\vec{c} + \vec{a})
            \\
            &= \left[\vec{a} \times \vec{b} + \vec{a} \times \vec{c} + \vec{b} \times \vec{c}\right]
            \cdot (\vec{c} + \vec{a})
            \\
            &= \left[\vec{a} \: \vec{b} \: \vec{c}\right] + \left[\vec{a} \: \vec{c} \: \vec{c}\right] + 
            \left[\vec{b} \: \vec{c} \: \vec{c}\right] + \left[\vec{a} \: \vec{b} \: \vec{a}\right] +
            \left[\vec{a} \: \vec{c} \: \vec{a}\right] + \left[\vec{b} \: \vec{c} \: \vec{a}\right]
        \end{split}
    \]
    ...
    \[
        \begin{split}
            & \left[(\vec{a} \times \vec{b}) \times (\vec{b} + \vec{c})\right] \times (\vec{c} + \vec{a})
            \\
