...
\input{letterfonts}
\graphicspath{{img/}}
\title{\includegraphics[width=7cm]{whu-logo.png} \\ \Huge{《机器人学》课程笔记}}
\author{魏崃\thanks{\href{mailto:lai-wei@whu.edu.cn}{lai-wei@whu.edu.cn}}}
\date{\today \\ \includegraphics[width=1.5in]{"../qrcode.png"}}
\begin{document}
...
\input{chapters/02-fundamentals-of-kinematics}
\input{chapters/03-robot-kinematics.tex}
\input{chapters/04-robot-speed-and-statics.tex}
\input{chapters/05-dynamics}
\input{chapters/06-motion-planning}
